				...
				<div class="inside">
					<div id="import-area">
						...
						<div style="background-color: #F5FAFD; margin:50px 0; padding: 25px 35px; clear:both;">
							<p><?php echo esc_html__('Here you can import layouts from our demo site, this is the easiest way to setup your theme. Before you import layouts please read the following.','uncode'); ?></p>
						...
						<?php
							...
							if($response && $can_read_file) {
								...
								<form class="js-one-click-import-form" style="text-align: center;">
									<input class="panel-save button-primary" type="submit" value="<?php echo esc_html__('IMPORT LAYOUTS','uncode'); ?>" style="height: 60px; width: 250px; font-size: 18px;" />
								</form>
								<?php
							} else { ?>
								<div>
